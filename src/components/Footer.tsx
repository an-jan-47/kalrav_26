    ...
    <footer className="relative w-full py-12 mt-10 border-t border-white/5 flex flex-col items-center justify-center gap-8 z-10 bg-transparent">
      ...
      >
        ...
        <div className="flex gap-4">
           <a href="https://github.com/an-jan-47" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-white transition-colors">
           ...
           <a href="https://www.linkedin.com/in/anjan-kumar-642889286" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-orange-400 transition-colors">
